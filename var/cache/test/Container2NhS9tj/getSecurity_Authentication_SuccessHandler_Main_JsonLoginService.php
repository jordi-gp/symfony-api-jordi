...
class getSecurity_Authentication_SuccessHandler_Main_JsonLoginService extends App_KernelTestDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['security.authentication.success_handler.main.json_login'])) {
            return $container->privates['security.authentication.success_handler.main.json_login'];
        }
        ...
        return $container->privates['security.authentication.success_handler.main.json_login'] = new \Symfony\Component\Security\Http\Authentication\CustomAuthenticationSuccessHandler(new \Lexik\Bundle\JWTAuthenticationBundle\Security\Http\Authentication\AuthenticationSuccessHandler($a, $b, [], true), [], 'main');
    }
}
