 ...
 */
class getVinil_ArtistFilterService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'vinil.artist_filter' shared service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['vinil.artist_filter'])) {
            return $container->privates['vinil.artist_filter'];
        }

        return $container->privates['vinil.artist_filter'] = new \ApiPlatform\Doctrine\Orm\Filter\SearchFilter(($container->services['doctrine'] ?? $container->getDoctrineService()), $a, ($container->privates['property_accessor'] ?? $container->getPropertyAccessorService()), ($container->privates['logger'] ?? ($container->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())), ['vinil.artista' => 'exact'], ($container->privates['serializer.name_converter.metadata_aware'] ?? $container->getSerializer_NameConverter_MetadataAwareService()));
    }
}
