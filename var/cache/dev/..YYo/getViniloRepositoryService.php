 ...
 */
class getViniloRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ViniloRepository' shared autowired service.
     *
     * @return \App\Repository\ViniloRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ViniloRepository.php';

        return $container->privates['App\\Repository\\ViniloRepository'] = new \App\Repository\ViniloRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
